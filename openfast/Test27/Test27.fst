...
FAST Certification Test #27: NREL 5.0 MW Baseline Wind Turbine with OC3 Monopile Soil-Pile-Intercation via linearized matrices; for use in offshore analysis
---------------------- SIMULATION CONTROL --------------------------------------
...
"NRELOffshrBsline5MW_OC3Monopile_SPI_SubDyn.dat"    SubFile         - Name of file containing sub-structural input parameters (quoted string)
